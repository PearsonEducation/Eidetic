...
public class SnapshotVolumeNoTime extends EideticSubThreadMethods implements Runnable, EideticSubThread {
    ...
    public SnapshotVolumeNoTime(String awsAccessKeyId, String awsSecretKey, String uniqueAwsAccountIdentifier, Integer maxApiRequestsPerSecond,
            Integer numRetries, com.amazonaws.regions.Region region, ArrayList<Volume> VolumeNoTime) {
    ...
    public boolean snapshotCreation(AmazonEC2Client ec2Client, Volume vol, String period, Date date) {
        ...
        try {
            ...
            try {
                ...
                logger.debug("awsAccountNickname=\"" + uniqueAwsAccountIdentifier_ + "\",Volume not attached to instance: " + vol.getVolumeId());
            }
