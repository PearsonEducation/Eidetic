...
public class FileIo {
    ...
    private static Logger logger = LoggerFactory.getLogger(FileIo.class.getName());
     ...
     * This is a quiet method.
     */
    public static boolean saveStringToFile(String saveFilePathAndFileName, String saveString) {
        
        if ((saveFilePathAndFileName == null) || saveFilePathAndFileName.isEmpty() ||
                (saveString == null) || saveString.isEmpty()) {
            return false;
        }
        ...
        try {  
            File outputFile = new File(saveFilePathAndFileName);      
            writer = new BufferedWriter(new FileWriter(outputFile));
